            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <br>
                        <a style="height: 40px;width: 50%;font-size: 15px;" class="btn btn-warning" href="/student-Donate/downloadPDF">Generate</a>
                        {{--<center>--}}
                    ...
                    <div class="col-lg-8">
                        ...
                        <form method="post" action="/student-Donate/donate-paypal">
                            {{csrf_field()}}
